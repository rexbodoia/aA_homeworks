...
describe Dessert do
  let(:chef) { double("chef", name: "Rex") }
  subject(:dessert) { Dessert.new("pie", 20, "chef") }
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new("pie", "20", "rex") }.to raise_error (ArgumentError)
    end
  end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ...
      dessert.mix!
      expect(dessert.ingredients).to_not equal(["milk", "eggs", "butter"])
    end
  end
